...
class PureFunctions {
  ...
  * @returns 'test string'
  */
  checkVariable = (value: string = '', isReturn: boolean = true, isTrim: boolean = true, isDash: boolean = false, uppercase: boolean = false) => {
    ...
    return isReturn ? string : (string === '' ? false : true);
  };
